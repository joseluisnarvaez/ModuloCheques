...
public class WPrincipal extends JFrame {
	...
	private static final long serialVersionUID = -4625379381510390811L;
    ...
    public WPrincipal() {
        ...
        this.menuVer            = new JMenu("Modulo 1 ");
        this.menuEdicion        = new JMenu("Modulo 2");
        this.menuAyuda          = new JMenu("Modulo 3");
